"""dylanapp_19654 URL Configuration
...
admin.site.site_header = "DylanApp"
admin.site.site_title = "DylanApp Admin Portal"
admin.site.index_title = "DylanApp Admin"

# swagger
api_info = openapi.Info(
    title="DylanApp API",
    default_version="v1",
    description="API documentation for DylanApp App",
)
